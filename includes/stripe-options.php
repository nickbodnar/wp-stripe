...
-->
		...
		<div id="wp-stripe-tab-about">
			<p>This plugin was orginially created by <a href="http://www.twitter.com/noeltock" target="_blank">@noeltock</a>, was expanded by <a href="http://hmn.md">Human Made</a>, and recurring payments were made possible by Nick Bodnar.</p>
		</div>
<?php }

function wp_stripe_delete_tests() {
	if ( isset( $_POST['wp_stripe_delete_tests'] ) && $_POST['wp_stripe_delete_tests'] === '1' ) {
		$test_transactions = new WP_query( [
