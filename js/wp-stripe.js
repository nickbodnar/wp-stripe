    ...
    function updateSummary() {
        ...
        if ( amount ) {
            if ( frequency ) {
                ...
                var frequencyText = frequency + ' months';
                if ( frequency == 1 ) {
                    frequencyText = 'month';
                }
                t = 'You will be charged $' + amount + ' now and this donation will renew every ' + frequencyText + '. Your next payment will occur on ' + nextDate.toLocaleDateString() + '.';
            } else {
